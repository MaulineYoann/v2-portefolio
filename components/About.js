    ...
    <section className={styles.about}>
      ...
      <section className={styles.sectionContain}>
        <aside className={styles.presentation}>
          <h2>Qui suis-je </h2>
          <p>
            <span>Passionné d'informatique</span> et de programmation c'est tout
            naturellement que je me reconverti dans ce domaine.
            <br />
            ...
            <span>Ouvert aux opportunités professionnels</span>, je serais ravis
            de pouvoir vous apporter mes compétences. N'hésiter pas à me
            contacter.
          </p>
        </aside>
